...
![График для случая 1](image/graf1.png){ #fig:001 width=70% height=70% }

![График для случая 2](image/graf2.png){ #fig:002 width=70% height=70% }

# Выводы
Изучила модель конкуренции и построены графики.